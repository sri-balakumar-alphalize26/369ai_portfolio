 ...
 * sizing. They are deliberately not uniform: these marks run from 0.89
 ...
 * Two needed real repair: Odoo shipped as RGB with a flat white ground and no
 * alpha channel at all (it rendered as a white box on the tinted section), and
 * DANAT's first file had a baked gradient backdrop. Both are fixed in the
 * committed PNGs — re-deriving them from the originals will reintroduce it.
 *
...
export const PARTNERS: Partner[] = [
  ...
  { name: 'DANAT Group', logo: '/images/partners/danat.png', w: 531, h: 600 },
